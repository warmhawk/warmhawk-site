  ...
  return (
    <div className="wrap py-16">
      ...
      <p className="text-ink-muted leading-relaxed mb-4">
        This Data Processing Agreement describes how WarmHawk (&ldquo;we,&rdquo;
        &ldquo;Processor&rdquo;), the operator of warmhawk.com and its billing/checkout flow,
        processes personal data as a processor on behalf of a customer (&ldquo;Customer,&rdquo;
        &ldquo;Controller&rdquo;), for organizations whose procurement process requires a standalone
        DPA. It is linked from the checkout flow for exactly that reason.
      </p>
      ...
      <p className="text-ink-muted leading-relaxed mb-4">
        ...
        end-user data on the vendor&rsquo;s own infrastructure. WarmHawk&rsquo;s architecture is the
        opposite: the product is fully self-hosted, running on Customer&rsquo;s own server, own
        Postgres database, and own containers. As a direct consequence, WarmHawk itself never
        ...
        relative to a typical SaaS DPA &mdash; it covers only the narrow slice of personal data that
        does reach WarmHawk&rsquo;s systems: billing and checkout data processed through Stripe.
      </p>
      ...
      <p className="text-ink-muted leading-relaxed mb-4">
        ...
        deciding why and how that data is processed; WarmHawk is the <strong>processor</strong> only
        for the narrow billing-contact data described in Section&nbsp;5, processing it solely on
        Customer&rsquo;s instructions to deliver the subscription Customer purchased.
      </p>
      ...
      <p className="text-ink-muted leading-relaxed mb-4">
        ...
        Customer&rsquo;s active subscription and for any retention period required afterward by tax,
        accounting, or other applicable law, consistent with the{' '}
      ...
      <p className="text-ink-muted leading-relaxed mb-4">
        WarmHawk engages <strong>Stripe, Inc.</strong> as its sole sub-processor for the processing
        described in this DPA, to handle payment processing and subscription billing. We will
        provide reasonable advance notice before adding or replacing a sub-processor for this
      ...
      <p className="text-ink-muted leading-relaxed mb-4">
        Where Stripe processes billing-contact data outside the EU/EEA or UK, such transfers are
        made subject to appropriate safeguards under Stripe&rsquo;s own data processing terms
        &mdash; including the EU Standard Contractual Clauses and, where applicable, a Data Privacy
        Framework certification &mdash; as published and kept current in Stripe&rsquo;s own DPA
        documentation. Because WarmHawk has no visibility into which specific mechanism Stripe
        applies to a given transfer at a given time, Customer should consult{' '}
        <a
        ...
        >
          Stripe&rsquo;s own current DPA
        </a>{' '}
        for the mechanism in effect.
      </p>
      ...
      <p className="text-ink-muted leading-relaxed mb-4">
        ...
        . WarmHawk has no ability to fulfill a request concerning Customer&rsquo;s lead or campaign
        data, since that data never reaches WarmHawk&rsquo;s systems; such requests must be handled
        by Customer directly on its own self-hosted instance.
      </p>
      ...
      <p className="text-ink-muted leading-relaxed mb-4">
        ...
        automatically alongside them. This DPA is governed by the laws of the State of Texas,
        without regard to its conflict-of-laws principles — the same governing law as the Terms of
        Service.
      </p>
