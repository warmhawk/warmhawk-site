  ...
  return (
    <div className="wrap py-16">
      ...
      <p className="text-ink-muted leading-relaxed mb-4">
        This Acceptable Use Policy sets out what you may and may not do when sending mail through a
        WarmHawk instance operated by WarmHawk (&ldquo;we,&rdquo; &ldquo;us&rdquo;). You must accept
        this Acceptable Use Policy (&ldquo;AUP&rdquo;), together with the{' '}
        ...
        , before your license can be activated, and it applies for as long as you run WarmHawk under
        a license we issued.
      </p>
      ...
      <p className="text-ink-muted leading-relaxed mb-4">
        You may not use WarmHawk, or any instance running under a WarmHawk license, to do any of the
        following. These four prohibitions are absolute and are not subject to a customer&rsquo;s
        own risk tolerance:
      </p>
      <ol className="list-decimal pl-6 mb-4 text-ink-muted leading-relaxed space-y-3">
        <li>
          ...
          including lists that were bought, scraped from the web, or otherwise assembled without the
          recipient&rsquo;s knowledge &mdash; is prohibited outright, regardless of jurisdiction.
        </li>
        <li>
        ...
        <li>
          <strong>Illegal content.</strong> Sending any content that is illegal under applicable law
          is prohibited.
        </li>
      </ol>
      ...
      <p className="text-ink-muted leading-relaxed mb-4">
        ...
        configurable default. You may not disable it, bypass it, or re-import a suppressed recipient
        back into an active send list.
      </p>
      ...
      <p className="text-ink-muted leading-relaxed mb-4">
        ...
        directly between your instance and your chosen provider. WarmHawk never stores, reviews, or
        has visibility into the AI-generated copy your instance produces. That relationship, and the
        content it produces, is between you and your AI provider &mdash; you remain responsible for
        complying with Anthropic&rsquo;s and Google&rsquo;s own usage policies for any content you
        generate through their models, independent of your obligations under this AUP.
      </p>
      ...
      <p className="text-ink-muted leading-relaxed mb-4">
        ...
        suspend or terminate your license without notice. Where we find a violation of this policy,
        we have no obligation to issue a refund of any amount already paid, including under the
        Tier&nbsp;1 money-back guarantee described in the Terms of Service.
      </p>
