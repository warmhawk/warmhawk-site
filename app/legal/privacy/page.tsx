  ...
  return (
    <div className="wrap py-16">
      ...
      <p className="text-ink-muted leading-relaxed mb-4">
        ...
        &ldquo;us&rdquo;), the operator of warmhawk.com and the WarmHawk billing path, with respect
        to visitors to our marketing site and customers who purchase a subscription. Because
        WarmHawk&rsquo;s product is fully self-hosted, this policy is intentionally narrow in scope
        &mdash; see Section&nbsp;2 for what falls entirely outside it.
      </p>
      ...
      <ul className="list-disc pl-6 mb-4 text-ink-muted leading-relaxed space-y-1.5">
        <li>
          <strong>Site analytics:</strong> aggregate traffic data about pages viewed on warmhawk.com
          (for example, referrer and page-path counts), measured without cookies by default. If you
          accept cookies via the on-page banner, we also recognize a return visit as the same person
          and may record session activity (including session replay) to see how the checkout flow
          actually behaves &mdash; see Section&nbsp;7. We do not build cross-site advertising
      ...
      <ul className="list-disc pl-6 mb-4 text-ink-muted leading-relaxed space-y-1.5">
        ...
        <li>
          ...
          analytics and respond to support correspondence, which we consider proportionate given the
          minimal, non-invasive data involved.
        </li>
      </ul>
      ...
      <p className="text-ink-muted leading-relaxed mb-4">
        Depending on your location, you may have the right to access, correct, delete, or receive a
        portable copy of the personal data we hold about you (billing and support data, as scoped
        above &mdash; this does not extend to data stored solely on your own self-hosted instance,
        which we cannot access). To exercise any of these rights, email{' '}
      ...
      <p className="text-ink-muted leading-relaxed mb-4">
        ...
        checkout, subscription billing, and payment-method storage. Stripe processes this data under
        its own privacy policy and applicable data protection agreements. We do not share billing
        data with any other third party for marketing purposes. See the{' '}
      ...
      <p className="text-ink-muted leading-relaxed mb-4">
        ...
        collect personal data from anyone under 16. If you believe a child has provided us personal
        data, contact us at {siteConfig.supportEmail} and we will delete it.
      </p>
      ...
      <p className="text-ink-muted leading-relaxed mb-4">
        ...
        conflict-of-laws principles — the same governing law as the{' '}
