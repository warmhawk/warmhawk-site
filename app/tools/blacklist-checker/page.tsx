      ...
      <div className="wrap pt-16 md:pt-24 pb-10">
        <div className="max-w-3xl">
          <div className="label text-rust mb-5">
            Email Blacklist Checker · plus MX, SPF, DKIM &amp; DMARC
          </div>
          ...
          <AnswerBlock>
            This checks your sending domain &mdash; and any sending addresses your own SPF record
            declares &mdash; against the Spamhaus domain blocklist. We deliberately never judge your
            reputation by your website&rsquo;s IP address, a different, unrelated signal. Paste up
            to 15 domains below to see live blacklist status alongside 4 more checks.
          </AnswerBlock>
        </div>
      </div>
